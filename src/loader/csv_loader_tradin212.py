...
SCHEMA = {
    ...
    "Withholding tax" : {                            "Deposit": FieldRule.FORBIDDEN, "Withdrawal": FieldRule.FORBIDDEN, "Market buy": FieldRule.FORBIDDEN, "Market sell": FieldRule.FORBIDDEN, "Limit buy": FieldRule.FORBIDDEN, "Dividend (Ordinary)": FieldRule.REQUIRED,  "Dividend (Dividend)": FieldRule.REQUIRED,  "Dividend (Tax exempted)": FieldRule.REQUIRED,  "Dividend (Dividend manufactured payment)": FieldRule.REQUIRED,  "Lending interest": FieldRule.FORBIDDEN, "Lending interest": FieldRule.FORBIDDEN, "Interest on cash": FieldRule.FORBIDDEN, "Card debit": FieldRule.FORBIDDEN, "Spending cashback": FieldRule.FORBIDDEN, "Stock split open": FieldRule.FORBIDDEN, "Stock split close": FieldRule.FORBIDDEN, "Currency conversion": FieldRule.FORBIDDEN }, # withholding tax is provided for dividents, but it the result is given already including it, so it's ignored. TODO: include it as fee or new field `tax`
